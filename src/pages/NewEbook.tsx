                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100 mt-4">
                    <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        <ChevronDown className={`w-3 h-3 transition-transform ${sourcePopoverOpen ? 'rotate-180' : ''}`} />
                      </button>
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        ...
                        <button
                          onClick={() => {
                            ...
                            handleSourceSelect('upload');
                          }}
                          className="flex flex-col items-center gap-2 p-4 border-2 border-dashed border-gray-200 rounded-xl hover:border-amber-300 hover:bg-amber-50/50 transition-all"
                        >
                        ...
                        <button
                          onClick={() => {
                            setSourcePopoverOpen(false);
                            handleSourceSelect('link');
                          }}
                          className="flex flex-col items-center gap-2 p-4 border-2 border-dashed border-gray-200 rounded-xl hover:border-blue-300 hover:bg-blue-50/50 transition-all"
                        >
                        ...
                        <button
                          onClick={() => {
                            setSourcePopoverOpen(false);
                            handleSourceSelect('record');
                          }}
                          className="flex flex-col items-center gap-2 p-4 border-2 border-dashed border-gray-200 rounded-xl hover:border-rose-300 hover:bg-rose-50/50 transition-all"
                        >

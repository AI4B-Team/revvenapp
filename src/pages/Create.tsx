...
import DynamicToolsSection from '@/components/dashboard/DynamicToolsSection';
...
const Create = () => {
  ...
  const [externalAnimateMode, setExternalAnimateMode] = useState<string | null>(null);
          ...
          <div className="px-3 sm:px-4 md:px-8 py-3 md:py-8">
            ...
            {selectedType !== 'Content' && activeView === 'tools' && (
              <div className="w-full">
                ...
                />
                <DynamicToolsSection category="Video" title="VIDEO APPS" selectedType={selectedType} />
                <DynamicToolsSection category="Audio" title="AUDIO APPS" selectedType={selectedType} />
                <DynamicToolsSection category="Design" title="DESIGN APPS" selectedType={selectedType} />
                <DynamicToolsSection category="Content" title="CONTENT APPS" selectedType={selectedType} />
                <DynamicToolsSection category="Apps" title="APP APPS" selectedType={selectedType} />
              </div>
            )}
          </div>
        </main>

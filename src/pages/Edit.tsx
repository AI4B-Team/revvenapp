  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground">
      ...
      <div className={`flex-1 flex flex-col overflow-hidden transition-all duration-300 ${isSidebarCollapsed ? 'ml-16' : 'ml-64'}`}>
        ...
        {/* Editor Type Tabs - First Row */}
        <div className="h-10 bg-background border-b border-border flex items-center px-4 gap-4 shrink-0">
          <button
            onClick={() => setEditorTab('image')}
            className={`flex items-center gap-2 px-3 py-1.5 text-sm font-medium transition-all ${
              editorTab === 'image' ? 'text-foreground border-b-2 border-primary' : 'text-muted-foreground hover:text-foreground'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-1.5 text-sm font-medium transition-all ${
              editorTab === 'video' ? 'text-foreground border-b-2 border-primary' : 'text-muted-foreground hover:text-foreground'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-1.5 text-sm font-medium transition-all ${
              editorTab === 'audio' ? 'text-foreground border-b-2 border-primary' : 'text-muted-foreground hover:text-foreground'
            }`}
          >

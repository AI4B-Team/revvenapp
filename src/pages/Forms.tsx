...
const Forms = () => {
  ...
  const SlackIcon = () => (
    <svg viewBox="0 0 127 127" className="w-6 h-6">
      ...
      <path fill="#36C5F0" d="M47 27c-7.3 0-13.2-5.9-13.2-13.2S39.7.6 47 .6s13.2 5.9 13.2 13.2V27H47zm0 6.7c7.3 0 13.2 5.9 13.2 13.2s-5.9 13.2-13.2 13.2H14c-7.3 0-13.2-5.9-13.2-13.2s5.9-13.2 13.2-13.2h33z"/>
      <path fill="#2EB67D" d="M99.9 46.9c0-7.3 5.9-13.2 13.2-13.2s13.2 5.9 13.2 13.2-5.9 13.2-13.2 13.2H99.9V46.9zm-6.6 0c0 7.3-5.9 13.2-13.2 13.2s-13.2-5.9-13.2-13.2V14c0-7.3 5.9-13.2 13.2-13.2s13.2 5.9 13.2 13.2v32.9z"/>
      <path fill="#ECB22E" d="M80.1 99.8c7.3 0 13.2 5.9 13.2 13.2s-5.9 13.2-13.2 13.2-13.2-5.9-13.2-13.2V99.8h13.2zm0-6.6c-7.3 0-13.2-5.9-13.2-13.2s5.9-13.2 13.2-13.2h33c7.3 0 13.2 5.9 13.2 13.2s-5.9 13.2-13.2 13.2h-33z"/>
    </svg>
  );

  const ZapierIcon = () => (
    <svg viewBox="0 0 244.4 244.4" className="w-6 h-6">
      <path fill="#FF4A00" d="M159.1 85.3l-36.9 36.9-36.9-36.9c-4.9-4.9-12.8-4.9-17.7 0s-4.9 12.8 0 17.7l36.9 36.9-36.9 36.9c-4.9 4.9-4.9 12.8 0 17.7 2.4 2.4 5.6 3.7 8.8 3.7s6.4-1.2 8.8-3.7l36.9-36.9 36.9 36.9c2.4 2.4 5.6 3.7 8.8 3.7s6.4-1.2 8.8-3.7c4.9-4.9 4.9-12.8 0-17.7l-36.9-36.9 36.9-36.9c4.9-4.9 4.9-12.8 0-17.7s-12.7-4.9-17.6 0z"/>
      <path fill="#FF4A00" d="M122.2 0C54.7 0 0 54.7 0 122.2s54.7 122.2 122.2 122.2 122.2-54.7 122.2-122.2S189.7 0 122.2 0zm0 219.4c-53.6 0-97.2-43.6-97.2-97.2s43.6-97.2 97.2-97.2 97.2 43.6 97.2 97.2-43.6 97.2-97.2 97.2z"/>
    </svg>
  );
  ...
  const StripeIcon = () => (
    <svg viewBox="0 0 28 28" className="w-6 h-6">
      ...
      <path fill="#fff" d="M13.3 11.5c0-.6.5-.8 1.3-.8 1.1 0 2.6.4 3.7.9V8.4c-1.2-.5-2.5-.7-3.7-.7-3 0-5.1 1.6-5.1 4.2 0 4.1 5.7 3.5 5.7 5.2 0 .7-.6.9-1.4.9-1.2 0-2.9-.5-4.2-1.2v3.2c1.4.6 2.9 1 4.2 1 3.1 0 5.2-1.5 5.2-4.2-.1-4.4-5.7-3.6-5.7-5.3z"/>
    </svg>
  );

  const PayPalIcon = () => (
    <svg viewBox="0 0 124 33" className="w-8 h-6">
      <path fill="#253B80" d="M46.2 6.7h-7.8c-.5 0-1 .4-1.1.9l-3.2 20c-.1.4.2.8.7.8h3.7c.5 0 1-.4 1.1-.9l.9-5.6c.1-.5.5-.9 1.1-.9h2.4c5.1 0 8-2.5 8.8-7.4.4-2.1 0-3.8-1-5-1.2-1.3-3.3-1.9-5.6-1.9zm.9 7.3c-.4 2.7-2.5 2.7-4.5 2.7h-1.2l.8-5c0-.3.3-.5.6-.5h.5c1.4 0 2.7 0 3.3.8.4.4.6 1.1.5 2z"/>
      <path fill="#179BD7" d="M82.1 6.7h-7.8c-.5 0-1 .4-1.1.9l-3.2 20c-.1.4.2.8.7.8h4c.4 0 .7-.3.7-.6l.9-5.8c.1-.5.5-.9 1.1-.9h2.4c5.1 0 8-2.5 8.8-7.4.4-2.1 0-3.8-1-5-1.2-1.3-3.3-1.9-5.5-1.9zm.9 7.3c-.4 2.7-2.5 2.7-4.5 2.7h-1.2l.8-5c0-.3.3-.5.6-.5h.5c1.4 0 2.7 0 3.3.8.4.4.6 1.1.5 2z"/>
      <path fill="#253B80" d="M65.1 13.9h-3.7c-.3 0-.6.2-.6.5l-.2 1-.2-.4c-.8-1.1-2.4-1.5-4-1.5-3.8 0-7 2.9-7.6 6.9-.3 2 .1 3.9 1.3 5.3 1 1.2 2.5 1.7 4.3 1.7 3.1 0 4.8-2 4.8-2l-.2 1c-.1.4.2.8.7.8h3.4c.5 0 1-.4 1.1-.9l2-12.6c0-.5-.3-.8-.8-.8zm-4.8 6.7c-.3 1.9-1.8 3.2-3.8 3.2-1 0-1.7-.3-2.2-.9-.5-.6-.7-1.4-.5-2.3.3-1.9 1.8-3.2 3.7-3.2 1 0 1.7.3 2.2.9.5.5.7 1.4.6 2.3z"/>
      <path fill="#179BD7" d="M101 13.9h-3.7c-.3 0-.6.2-.6.5l-.2 1-.2-.4c-.8-1.1-2.4-1.5-4-1.5-3.8 0-7 2.9-7.6 6.9-.3 2 .1 3.9 1.3 5.3 1 1.2 2.5 1.7 4.3 1.7 3.1 0 4.8-2 4.8-2l-.2 1c-.1.4.2.8.7.8h3.4c.5 0 1-.4 1.1-.9l2-12.6c0-.5-.3-.8-.8-.8zm-4.9 6.7c-.3 1.9-1.8 3.2-3.8 3.2-1 0-1.7-.3-2.2-.9-.5-.6-.7-1.4-.5-2.3.3-1.9 1.8-3.2 3.7-3.2 1 0 1.7.3 2.2.9.6.5.8 1.4.6 2.3z"/>
      <path fill="#179BD7" d="M108.7 7.1l-3.2 20.4c-.1.4.2.8.7.8h3.2c.5 0 1-.4 1.1-.9l3.2-20c.1-.4-.2-.8-.7-.8h-3.6c-.4-.1-.6.2-.7.5z"/>
    </svg>
  );
  ...
  const integrations: Integration[] = [
    ...
    { id: 'slack', name: 'Slack', icon: <SlackIcon />, connected: true },
    { id: 'zapier', name: 'Zapier', icon: <ZapierIcon />, connected: true },
    { id: 'stripe', name: 'Stripe', icon: <StripeIcon />, connected: false },
    { id: 'paypal', name: 'PayPal', icon: <PayPalIcon />, connected: false }
  ];

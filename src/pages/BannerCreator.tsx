...
const BannerCreator = () => {
  ...
  const handleDownload = () => {
    ...
    a.download = `banner-${platform}-${Date.now()}.png`;
    a.click();
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h1 className="text-2xl font-bold text-foreground">Banner Creator</h1>
                <p className="text-muted-foreground">Design stunning social media banners</p>
              </div>
            </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="description"
                      placeholder="Additional context for the banner"
                      value={description}
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={platform} onValueChange={setPlatform}>
                      ...
                      <SelectContent>
                        <SelectItem value="facebook">Facebook Cover</SelectItem>
                        <SelectItem value="twitter">Twitter Header</SelectItem>
                        <SelectItem value="linkedin">LinkedIn Banner</SelectItem>
                        <SelectItem value="youtube">YouTube Banner</SelectItem>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={style} onValueChange={setStyle}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="gradient">Gradient & Colorful</SelectItem>

...
const suggestionsByIntent: IntentSuggestions = {
  Create: [
    ...
    [
      { id: 'animation', icon: Video, iconColor: 'text-purple-600', title: 'Motion Graphics', description: 'Animate your brand.', prompt: 'Create animated motion graphics for social media ads with brand elements' },
      { id: 'whitepaper', icon: FileText, iconColor: 'text-slate-700', title: 'Whitepaper', description: 'Deep expertise shown.', prompt: 'Write a comprehensive whitepaper on industry trends and insights' },
      { id: 'ugc', icon: Users, iconColor: 'text-rose-500', title: 'UGC Scripts', description: 'Authentic content.', prompt: 'Create 5 user-generated content scripts for influencer partnerships' },
      { id: 'ad-creative', icon: Image, iconColor: 'text-blue-500', title: 'Ad Creatives', description: 'Ads that convert.', prompt: 'Design high-converting ad creatives for Facebook and Instagram campaigns' },
      { id: 'pitch-deck', icon: FileText, iconColor: 'text-violet-500', title: 'Pitch Deck', description: 'Win investors over.', prompt: 'Create a compelling 15-slide pitch deck for my startup' },
      { id: 'soundbites', icon: Mic, iconColor: 'text-emerald-500', title: 'Sound Bites', description: 'Quotable moments.', prompt: 'Create catchy audio soundbites for social media and podcast clips' },
    ],
    [
      { id: 'twitter-thread', icon: FileText, iconColor: 'text-sky-500', title: 'Twitter Threads', description: 'Viral wisdom.', prompt: 'Write a 15-tweet thread breaking down a complex topic in my niche' },
      { id: 'product-video', icon: Video, iconColor: 'text-amber-500', title: 'Product Demo', description: 'Features in action.', prompt: 'Create a product demonstration video highlighting key features and benefits' },
      { id: 'brand-kit', icon: Sparkles, iconColor: 'text-pink-500', title: 'Brand Kit', description: 'Visual identity.', prompt: 'Design a complete brand kit with logos, colors, and typography guidelines' },
      { id: 'course-content', icon: FileText, iconColor: 'text-indigo-500', title: 'Course Content', description: 'Teach and earn.', prompt: 'Create a 10-module online course outline with lesson plans' },
      { id: 'audio-ad', icon: Music, iconColor: 'text-red-500', title: 'Audio Ads', description: 'Ears that convert.', prompt: 'Create a 30-second audio advertisement for podcast sponsorship' },
      { id: 'social-stories', icon: Image, iconColor: 'text-teal-500', title: 'Story Templates', description: 'Daily engagement.', prompt: 'Design 10 Instagram Story templates for daily content' },
    ],
    [
      { id: 'bts-content', icon: Video, iconColor: 'text-orange-500', title: 'Behind The Scenes', description: 'Show the journey.', prompt: 'Create behind-the-scenes content strategy for authentic brand storytelling' },
      { id: 'email-templates', icon: Mail, iconColor: 'text-blue-600', title: 'Email Templates', description: 'Inbox excellence.', prompt: 'Design 10 professional email templates for different marketing purposes' },
      { id: 'sticker-pack', icon: Sparkles, iconColor: 'text-yellow-500', title: 'Sticker Pack', description: 'Fun interactions.', prompt: 'Create a branded sticker pack for social media and messaging apps' },
      { id: 'product-photos', icon: Image, iconColor: 'text-violet-500', title: 'Product Photos', description: 'Catalog ready.', prompt: 'Generate professional product photography for e-commerce listings' },
      { id: 'intro-outro', icon: Video, iconColor: 'text-cyan-500', title: 'Intro & Outro', description: 'Professional polish.', prompt: 'Create branded video intro and outro animations for YouTube content' },
      { id: 'hooks', icon: FileText, iconColor: 'text-rose-500', title: 'Content Hooks', description: 'Stop the scroll.', prompt: 'Write 50 attention-grabbing hooks for social media content' },
    ],
    [
      { id: 'comparison', icon: BarChart3, iconColor: 'text-green-500', title: 'Comparison Content', description: 'Help them decide.', prompt: 'Create comparison content showing your product vs competitors' },
      { id: 'tutorial', icon: Video, iconColor: 'text-purple-500', title: 'Tutorial Video', description: 'Teach with value.', prompt: 'Create a step-by-step tutorial video teaching a skill in my niche' },
      { id: 'announcement', icon: Sparkles, iconColor: 'text-amber-500', title: 'Announcement Post', description: 'News that excites.', prompt: 'Create an exciting product or feature announcement for social media' },
      { id: 'press-release', icon: FileText, iconColor: 'text-slate-600', title: 'Press Release', description: 'Media-ready news.', prompt: 'Write a professional press release for an upcoming launch or announcement' },
      { id: 'asmr', icon: Music, iconColor: 'text-pink-500', title: 'ASMR Content', description: 'Sensory experience.', prompt: 'Create ASMR-style audio content for relaxation and engagement' },
      { id: 'gif-pack', icon: Image, iconColor: 'text-teal-500', title: 'GIF Collection', description: 'Reactions ready.', prompt: 'Create a branded GIF collection for social media and messaging' },
    ],
  ],
  Research: [
    [
  ...
  Plan: [
    ...
    [
      ...
      { id: 'affiliate', icon: BarChart3, iconColor: 'text-amber-500', title: 'Affiliate Program', description: 'Partner for profit.', prompt: 'Design an affiliate marketing program with commission structure' },
      { id: 'user-onboarding', icon: Lightbulb, iconColor: 'text-cyan-500', title: 'Onboarding Flow', description: 'First impressions.', prompt: 'Create a user onboarding experience that maximizes activation' },
    ],
    [
      ...
      { id: 'expansion', icon: TrendingUp, iconColor: 'text-green-500', title: 'Expansion Plan', description: 'New horizons.', prompt: 'Plan market expansion strategy for entering new demographics or regions' },
      { id: 'content-audit', icon: Search, iconColor: 'text-purple-500', title: 'Content Audit Plan', description: 'Review and renew.', prompt: 'Create a content audit framework to identify refresh opportunities' },
    ],
    [
      ...
      { id: 'ux-roadmap', icon: Target, iconColor: 'text-cyan-600', title: 'UX Roadmap', description: 'Experience evolution.', prompt: 'Plan user experience improvements with prioritized enhancements' },
      { id: 'automation-plan', icon: Zap, iconColor: 'text-emerald-600', title: 'Automation Roadmap', description: 'Scale smart.', prompt: 'Create a marketing automation implementation roadmap' },
    ],
    [
      ...
      { id: 'feedback-loop', icon: Lightbulb, iconColor: 'text-indigo-600', title: 'Feedback System', description: 'Continuous improve.', prompt: 'Design a customer feedback collection and implementation system' },
      { id: 'pricing-strategy', icon: BarChart3, iconColor: 'text-green-600', title: 'Pricing Strategy', description: 'Value-based.', prompt: 'Develop a pricing strategy with tiers and promotional offers' },
  ...
  Automate: [
    ...
    [
      { id: 'competitor-alert', icon: Search, iconColor: 'text-blue-500', title: 'Competitor Alerts', description: 'Stay informed.', prompt: 'Set up automated alerts for competitor activities and announcements' },
      { id: 'content-expire', icon: Calendar, iconColor: 'text-slate-600', title: 'Content Expiration', description: 'Always fresh.', prompt: 'Automate content expiration notifications and updates' },
      { id: 'nps-survey', icon: BarChart3, iconColor: 'text-emerald-600', title: 'NPS Automation', description: 'Measure loyalty.', prompt: 'Set up automated NPS surveys and follow-up based on scores' },
      { id: 'social-report', icon: TrendingUp, iconColor: 'text-purple-600', title: 'Social Reports', description: 'Weekly insights.', prompt: 'Automate weekly social media performance reports' },
      { id: 'referral-track', icon: Users, iconColor: 'text-orange-600', title: 'Referral Tracking', description: 'Reward automatically.', prompt: 'Automate referral tracking and reward distribution' },
      { id: 'seo-monitor', icon: Target, iconColor: 'text-indigo-600', title: 'SEO Monitoring', description: 'Rank tracking.', prompt: 'Set up automated SEO rank tracking and alerts for key terms' },
    ],
  ],
};

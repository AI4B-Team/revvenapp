    ...
    <div className="p-8 max-w-screen-2xl mx-auto">
      ...
      <div className="space-y-4">
        {teamMembers.map((member, index) => (
          <div key={index} className="bg-white border border-gray-200 rounded-xl p-6 flex items-center justify-between hover:shadow-md transition-all">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">{member.calls} calls this week</p>
              </div>
            </div>
            ...
            <div className="flex gap-8">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-600">{member.aiUsage}%</div>

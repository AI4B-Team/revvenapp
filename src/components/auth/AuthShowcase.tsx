...
export const showcaseSlides = [
  ...
  },
  {
    ...
    description: "Create lifelike AI influencers and spokespersons that work 24/7. Clone your voice, animate photos, and scale your personal brand infinitely.",
  ...
  // Social Media Automation Flow
  {
    ...
    description: "30 days of content in 30 seconds. AI writes captions, designs graphics, and creates videos automatically. Your content machine never stops.",
    features: ["AI Copywriting", "Auto Graphics", "Batch Creation"],
    bgColor: "bg-sky-50",
  ...
  },
  {
    ...
    description: "Set it and forget it. AI schedules your content at peak engagement times and posts across every platform automatically.",
    features: ["Smart Scheduling", "Multi-Platform", "Auto Publish"],
    bgColor: "bg-rose-50",

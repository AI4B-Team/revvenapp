...
interface AppsFilterToolbarProps {
...
const AppsFilterToolbar = ({ 
  onZoomChange, 
  zoom = 50, 
  onFiltersChange, 
  selectedCategory = 'All', 
  onCategoryChange
}: AppsFilterToolbarProps) => {
            ...
            <div className="absolute left-0 top-full mt-2 w-80 bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 overflow-hidden">
              ...
              <div className="px-5 py-4 max-h-[400px] overflow-y-auto">
                  ...
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <div className="relative flex items-center">
                      <input
                        ...
                        onChange={() => setFilters(prev => ({ ...prev, trending: !prev.trending }))}
                  ...
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <div className="relative flex items-center">
                      <input
                        ...
                        onChange={() => setFilters(prev => ({ ...prev, favorites: !prev.favorites }))}
                        className="w-5 h-5 border-2 border-gray-300 rounded cursor-pointer appearance-none checked:bg-gray-900 checked:border-gray-900 transition-colors"
                      />
                      {filters.favorites && (
                        <svg 
                  ...
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <div className="relative flex items-center">
                      <input
                        ...
                        onChange={() => setFilters(prev => ({ ...prev, recentlyAdded: !prev.recentlyAdded }))}
                        className="w-5 h-5 border-2 border-gray-300 rounded cursor-pointer appearance-none checked:bg-gray-900 checked:border-gray-900 transition-colors"
                      />
                ...
                <div className="space-y-3">
                  <h4 className="text-sm font-semibold text-gray-900 mb-3">Install Date</h4>
...
export default AppsFilterToolbar;

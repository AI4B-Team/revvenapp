    ...
    <>
      ...
      <div className="fixed inset-0 bg-black z-50 flex">
        ...
        {onPrevious && (
          <button
            onClick={onPrevious}
            className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center transition-colors z-40"
            title="Previous"
          >
        ...
        {onNext && (
          <button
            onClick={onNext}
            className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center transition-colors z-40"
            title="Next"
          >
        ...
        {/* Main Content Area */}
        <div className="flex-1 flex items-center justify-center p-20 pr-96">
          ...
          <div className="relative max-w-full max-h-full group">
            ...
            <div className="absolute top-4 right-4 flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              <button
                ...
                className={`w-10 h-10 rounded-lg backdrop-blur-sm flex items-center justify-center transition-all ${
                  isFeatured
            ...
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
              {/* Download */}
              <button
                className="px-4 py-2 bg-black/70 hover:bg-black/80 backdrop-blur-sm text-white rounded-lg flex items-center gap-2 transition-colors"
                title="Download"
              >
                <Download size={18} />

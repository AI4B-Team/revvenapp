...
export const allApps: AppTab[] = [
  { id: 'create', label: 'Create', icon: Wand2, color: 'text-white', bgColor: 'bg-emerald-400', path: '/create' },
  { id: 'master-closer', label: 'Master Closer', icon: Zap, color: 'text-white', bgColor: 'bg-emerald-400', path: '/master-closer' },
  { id: 'editor', label: 'Editor', icon: FileEdit, color: 'text-white', bgColor: 'bg-purple-400', path: '/edit' },
  { id: 'sessions', label: 'Sessions', icon: Video, color: 'text-white', bgColor: 'bg-blue-400', path: '/sessions' },
  { id: 'ai-influencer', label: 'AI Influencer', icon: Users, color: 'text-white', bgColor: 'bg-violet-400', path: '/ai-influencer' },
  { id: 'ai-story', label: 'AI Story', icon: BookOpen, color: 'text-white', bgColor: 'bg-amber-400', path: '/ai-story' },
  { id: 'viral-shorts', label: 'Viral Shorts', icon: Zap, color: 'text-white', bgColor: 'bg-red-400', path: '/viral-shorts' },
  { id: 'voiceovers', label: 'Voiceovers', icon: Mic, color: 'text-white', bgColor: 'bg-cyan-400', path: '/voiceovers' },
  { id: 'voice-cloner', label: 'Voice Cloner', icon: Volume2, color: 'text-white', bgColor: 'bg-purple-400', path: '/voice-cloner' },
  { id: 'voice-changer', label: 'Voice Changer', icon: Music, color: 'text-white', bgColor: 'bg-pink-400', path: '/voice-changer' },
  { id: 'transcribe', label: 'Transcribe', icon: FileText, color: 'text-white', bgColor: 'bg-indigo-400', path: '/transcribe' },
  { id: 'audio-dubber', label: 'Audio Dubber', icon: Globe, color: 'text-white', bgColor: 'bg-teal-400', path: '/audio-dubber' },
  { id: 'noise-remover', label: 'Noise Remover', icon: Eraser, color: 'text-white', bgColor: 'bg-slate-400', path: '/noise-remover' },
  { id: 'background-remover', label: 'Background Remover', icon: Image, color: 'text-white', bgColor: 'bg-rose-400', path: '/background-remover' },
  { id: 'image-enhancer', label: 'Image Enhancer', icon: Sparkles, color: 'text-white', bgColor: 'bg-orange-400', path: '/image-enhancer' },
  { id: 'image-upscaler', label: 'Image Upscaler', icon: ArrowUpCircle, color: 'text-white', bgColor: 'bg-lime-400', path: '/image-upscaler' },
  { id: 'video-downloader', label: 'Video Downloader', icon: Download, color: 'text-white', bgColor: 'bg-sky-400', path: '/video-downloader' },
  { id: 'explainer-video', label: 'Explainer Video', icon: Video, color: 'text-white', bgColor: 'bg-fuchsia-400', path: '/explainer-video' },
  { id: 'ebook-creator', label: 'Ebook Creator', icon: BookOpen, color: 'text-white', bgColor: 'bg-amber-500', path: '/ebook-creator' },
  { id: 'blog-writer', label: 'Blog Writer', icon: FileEdit, color: 'text-white', bgColor: 'bg-green-400', path: '/blog-writer' },
  { id: 'social-posts', label: 'Social Posts', icon: Calendar, color: 'text-white', bgColor: 'bg-blue-400', path: '/social-posts' },
  { id: 'newsletter', label: 'Newsletter', icon: Mail, color: 'text-white', bgColor: 'bg-red-400', path: '/newsletter' },
  { id: 'ad-copy-writer', label: 'Ad Copy Writer', icon: Megaphone, color: 'text-white', bgColor: 'bg-yellow-400', path: '/ad-copy-writer' },
  { id: 'script-writer', label: 'Script Writer', icon: FileText, color: 'text-white', bgColor: 'bg-violet-400', path: '/script-writer' },
  { id: 'email-generator', label: 'Email Generator', icon: Mail, color: 'text-white', bgColor: 'bg-cyan-400', path: '/email-generator' },
  { id: 'seo-optimizer', label: 'SEO Optimizer', icon: Search, color: 'text-white', bgColor: 'bg-emerald-400', path: '/seo-optimizer' },
  { id: 'lead-generation', label: 'Lead Generation', icon: Users, color: 'text-white', bgColor: 'bg-blue-400', path: '/lead-generation' },
  { id: 'ai-agents', label: 'AI Agents', icon: Bot, color: 'text-white', bgColor: 'bg-purple-400', path: '/ai-agents' },
  { id: 'versus', label: 'Versus', icon: Zap, color: 'text-white', bgColor: 'bg-orange-400', path: '/versus' },
  { id: 'forms', label: 'Forms', icon: ClipboardList, color: 'text-white', bgColor: 'bg-indigo-400', path: '/forms' },
  { id: 'digital-spy', label: 'Digital Spy', icon: BarChart3, color: 'text-white', bgColor: 'bg-emerald-400', path: '/digital-spy' },
  { id: 'inbox', label: 'Inbox', icon: Mail, color: 'text-white', bgColor: 'bg-blue-400', path: '/inbox' },
  { id: 'investor-calculator', label: 'Investor Calculator', icon: DollarSign, color: 'text-white', bgColor: 'bg-green-400', path: '/investor-calculator' },
  { id: 'ai-responder', label: 'AI Responder', icon: Bot, color: 'text-white', bgColor: 'bg-yellow-400', path: '/ai-responder' },
  { id: 'signature', label: 'Signature', icon: FileEdit, color: 'text-white', bgColor: 'bg-slate-400', path: '/signature' },
];

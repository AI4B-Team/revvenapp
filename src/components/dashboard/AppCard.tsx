...
// Category-based icon colors for the rounded square icon badges (pastel)
const categoryIconColors: { [key: string]: string } = {
  'Video Tool': 'bg-blue-300',
  'Video Tools': 'bg-blue-300',
  'Image Tool': 'bg-purple-300',
  'Image Tools': 'bg-purple-300',
  'Audio Tool': 'bg-amber-300',
  'Audio Tools': 'bg-amber-300',
  'Design Tool': 'bg-pink-300',
  'Design Tools': 'bg-pink-300',
  'Content Tool': 'bg-emerald-300',
  'Content Tools': 'bg-emerald-300',
  'Avatar Creator': 'bg-indigo-300',
  'Ad Maker': 'bg-red-300',
  'LLM Tool': 'bg-slate-400',
  'Tool': 'bg-slate-400',
  'Tools': 'bg-slate-400',
  'Content Intelligence': 'bg-teal-300',
  'Communication': 'bg-cyan-300',
  'Real Estate': 'bg-orange-300',
  'Sales Tool': 'bg-green-300',
  'Sales Tools': 'bg-green-300',
};

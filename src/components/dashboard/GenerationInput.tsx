                ...
                <div className="space-y-1 p-2">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-0.5">
                          <span className="font-semibold text-foreground text-sm">Imagen 4</span>
                        </div>
                        <p className="text-xs text-muted-foreground">Google's latest image model</p>
                      </div>
                    </div>
                  </button>
                </div>

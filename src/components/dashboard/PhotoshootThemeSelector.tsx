...
const PHOTOSHOOT_THEMES: PhotoTheme[] = [
  // Seasonal & Holiday
  {
    ...
    creator: 'frostbyte',
    images: [
      'https://images.unsplash.com/photo-1483664852095-d6cc6870702d?w=400&h=500&fit=crop&q=80',
      'https://images.unsplash.com/photo-1418985991508-e47386d96a71?w=400&h=500&fit=crop&q=80',
      'https://images.unsplash.com/photo-1482192505345-5655af888cc4?w=400&h=500&fit=crop&q=80'
    ]
  },
  {
    id: 'christmas-magic',
  ...
  // Holiday Specific
  {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1570051008600-b34baa49e751?w=400&h=500&fit=crop&q=80'
    ]
  },
  {
    id: 'valentines-love',
  ...
  // Events
  {
    ...
    creator: 'bridetribe',
    images: [
      'https://images.unsplash.com/photo-1529543544599-b9509ac95f77?w=400&h=500&fit=crop&q=80',
  ...
  // Religious & Cultural
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1609220136736-443140cffec6?w=400&h=500&fit=crop&q=80',
      'https://images.unsplash.com/photo-1581579438747-1dc8d17bbce4?w=400&h=500&fit=crop&q=80',
      'https://images.unsplash.com/photo-1596697113069-b063fcf8e5ea?w=400&h=500&fit=crop&q=80'
    ]
  },
  {
    id: 'diwali-lights',
...
const PhotoshootThemeSelector: React.FC<PhotoshootThemeSelectorProps> = ({ 
  ...
  return (
    <div className="w-full bg-white rounded-2xl p-4 max-h-[500px] overflow-y-auto">
